        ...
        self.user_data = [
            {
                ...
                "email": user.email,
                "departureCity": user.departure_city,
                "departureIata": user.departure_iata,
                "currency": user.currency,
                "nightsFrom": user.min_nights,
                "nightsTo": user.max_nights,
                "minDaysAhead": user.min_days_ahead,
                "maxDaysAhead": user.max_days_ahead,
                "dreamPlaces": user.travel_countries.split(","),
                "excludedCountries": user.excluded_countries.split(",")
                if user.excluded_countries
                else [],
            }
